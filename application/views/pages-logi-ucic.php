...
<head>
  <meta charset="utf-8">
    ...
    <title>Login | Pihak Kampus</title>
                ...
                <div class="row no-gutters justify-content-md-center">
                    ...
                    <div class="col-lg-5 col-md-4 col-12">
                        ...
                        <div class="content-top-agile h-p100">
                            <h2 class="text-secondary"><b>Sistem Kepuasan</b><br><b> Alumni & Stakeholder</b></h2>
                            <p class="text-white">
                    ...
                    <div class="ribbon ribbon-bookmark ribbon-right bg-primary"><i class="fa fa-users"></i>&nbsp;&nbsp;<b> LOGIN PIHAK KAMPUS</b></div>
...
<div class="form-group">
                      ...
                      <option value="Administrator">Kemahasiswaan</option>
                      <option value="Dekan">Dekan</option>
                      <option value="Kaprodi">Kaprodi</option>
                      <option value="Kemahasiswaan">Kemahasiswaan Prodi</option>
                    </select>
                                    </div>
                                </div>
