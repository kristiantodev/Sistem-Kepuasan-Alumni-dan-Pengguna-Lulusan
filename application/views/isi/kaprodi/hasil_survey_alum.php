...
Program Studi : <?=$myprodi->nm_prodi;?></b></h6>
  ...
  <!-- selesai row -->
                                            ...
                                            <ul class="nav nav-tabs nav-tabs-custom" role="tablist">
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link active" data-toggle="tab" href="#home1" role="tab"><b><font color=""><i class="fas fa-chart-bar"></i>&nbsp; Grafik Jumlah Responden</font></b></a>
                                                </li>

                                                <li class="nav-item">
                                                    <a class="nav-link" data-toggle="tab" href="#home2" role="tab"><b><font color=""><i class="fas fa-chart-pie"></i>&nbsp; Grafik Tingkat Kinerja dan Harapan Alumni</font></b></a>
                                                </li>
                                            ...
                                            <div class="tab-content">
                                                ...
                                                <div class="tab-pane active p-3" id="home1" role="tabpanel">
                                                   ...
                                                   <canvas id="chart_jumlah" height="300"></canvas>
