        ...
        <link href="<?php echo base_url();?>assets/plugins/bootstrap-md-datetimepicker/css/bootstrap-material-datetimepicker.css" rel="stylesheet">
                            ...
                            <?php endif; ?>
                                        ...
                                        <!-- Nav tabs -->
                                            <ul class="nav nav-tabs nav-tabs-custom" role="tablist">
                                                <li class="nav-item">
                                                    <a class="nav-link active" data-toggle="tab" href="#home1" role="tab"><b><i class="fas fa-th-large"></i> &nbsp;Teknik Informatika</b></a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" data-toggle="tab" href="#profile1" role="tab"><b><i class="fas fa-th-large"></i> &nbsp;SIKA</b></a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" data-toggle="tab" href="#profile2" role="tab"><b><i class="fas fa-th-large"></i> &nbsp;DKV</b></a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" data-toggle="tab" href="#profile3" role="tab"><b><i class="fas fa-th-large"></i> &nbsp;D3-MI</b></a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" data-toggle="tab" href="#profile4" role="tab"><b><i class="fas fa-th-large"></i> &nbsp;D3-KA</b></a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" data-toggle="tab" href="#profile5" role="tab"><b><i class="fas fa-th-large"></i> &nbsp;Managemen Bisnis</b></a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" data-toggle="tab" href="#profile6" role="tab"><b><i class="fas fa-th-large"></i> &nbsp;Manajemen</b></a>
                                                    <li class="nav-item">
                                                    <a class="nav-link" data-toggle="tab" href="#profile7" role="tab"><b><i class="fas fa-th-large"></i> &nbsp;Akuntansi</b></a>
                                                </li>
                                                </li>
                                    ...
                                    <th><b>Aksi</b></th>
                                                ...
                                                <tbody>
                                             <?php $no=1;
         foreach ($alumniku as $alumni): ?>
         <?php if ($alumni->id_prodi == 1){ ?>
                                <tr>
                 ...
                 <a data-toggle="modal" data-target="#modalku<?php echo $alumni->id_user ?>" class="btn btn-success waves-effect waves-light"><span data-toggle="tooltip" data-original-title="Kirim Email"><font color="white"><i class="fab fa-facebook-messenger"></i></font></span></a>
                                ...
                                <?php endforeach; ?>
                                                ...
                                                <div class="tab-pane p-3" id="profile2" role="tabpanel">
                                                         <table id="datatable3" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                <thead>
                                                <tr>
                                    <th width="9"><b>Foto</b></th>
                                    <th><b>NIM</b></th>
                 ...
                 <a data-toggle="modal" data-target="#modalku<?php echo $alumni->id_user ?>" class="btn btn-success waves-effect waves-light"><span data-toggle="tooltip" data-original-title="Kirim Email"><font color="white"><i class="fab fa-facebook-messenger"></i></font></span></a>
                                ...
                                <?php endforeach; ?>
                                                ...
                                                <div class="tab-pane p-3" id="profile3" role="tabpanel">
                                                         <table id="datatable4" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                <thead>
                                                <tr>
                                    <th width="9"><b>Foto</b></th>
                                    <th><b>NIM</b></th>
         ...
         <?php if ($alumni->id_prodi == 5){ ?>
                 ...
                 <a data-toggle="modal" data-target="#modalku<?php echo $alumni->id_user ?>" class="btn btn-success waves-effect waves-light"><span data-toggle="tooltip" data-original-title="Kirim Email"><font color="white"><i class="fab fa-facebook-messenger"></i></font></span></a>
                                ...
                                <?php endforeach; ?>
                                                ...
                                                <div class="tab-pane p-3" id="profile5" role="tabpanel">
                                                         <table id="datatable6" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                <thead>
                                                <tr>
                                    <th width="9"><b>Foto</b></th>
                                    <th><b>NIM</b></th>
         ...
         <?php if ($alumni->id_prodi == 6){ ?>
                 ...
                 <a data-toggle="modal" data-target="#modalku<?php echo $alumni->id_user ?>" class="btn btn-success waves-effect waves-light"><span data-toggle="tooltip" data-original-title="Kirim Email"><font color="white"><i class="fab fa-facebook-messenger"></i></font></span></a>
                                ...
                                <?php endforeach; ?>
                                                ...
                                                <div class="tab-pane p-3" id="profile6" role="tabpanel">
                                                         <table id="datatable7" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                <thead>
                                                <tr>
                                    <th width="9"><b>Foto</b></th>
                                    <th><b>NIM</b></th>
                 ...
                 <a data-toggle="modal" data-target="#modalku<?php echo $alumni->id_user ?>" class="btn btn-success waves-effect waves-light"><span data-toggle="tooltip" data-original-title="Kirim Email"><font color="white"><i class="fab fa-facebook-messenger"></i></font></span></a>
                                ...
                                <?php endforeach; ?>
                                                ...
                                                <div class="tab-pane p-3" id="profile7" role="tabpanel">
                                                         <table id="datatable8" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                <thead>
                                                <tr>
                                    <th width="9"><b>Foto</b></th>
                                    <th><b>NIM</b></th>
               ...
               <!-- Modal -->
                  <div class="modal fade text-left" id="bb" tabindex="-1" role="dialog" aria-labelledby="myModalLabel16" aria-hidden="true">
                    ...
                    <div class="modal-content">
                      ...
                      <form action="<?php echo site_url('adm/alumni/add'); ?>" method="post" enctype="multipart/form-data">
 ...
 <?php $no=0; foreach ($alumniku as $alumni): ?>
                  ...
                  <div class="modal fade text-left" id="modal-edit<?php echo $alumni->id_user ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel16" aria-hidden="true">
                    ...
                    <div class="modal-content">
                      ...
                      <form action="<?php echo site_url('adm/alumni/edit'); ?>" method="post" enctype="multipart/form-data">
 ...
 <?php $no=0; foreach ($alumniku as $alumni): ?>
                  <div class="modal fade text-left" id="modalku<?php echo $alumni->id_user ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel16" aria-hidden="true">
                    ...
                    <div class="modal-content">
                      ...
                      <form action="<?php echo site_url('adm/alumni/kirim_email'); ?>" method="post">
