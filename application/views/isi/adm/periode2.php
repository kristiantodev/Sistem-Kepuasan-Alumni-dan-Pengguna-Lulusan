                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="page-title-box">
                                    <h3 class="page-title"><b><i class="fas fa-clock"></i>&nbsp;Periode Survei Kepuasan</b></h3>
                                    <ol class="breadcrumb">
...
<div class="alert alert-warning alert-dismissible fade show" role="alert">
                                                    ...
                                                    <strong><i class="fas fa-bullhorn"></i>&nbsp;&nbsp;Warning!</strong> Hanya 1 Periode yang harus Diaktifkan.
                                                </div>
                                    ...
                                    <th width="200" align="center"><b>Isactive</b></th>
         ...
         foreach ($periodeku as $periode): ?>
                        ...
                        <button class="btn btn-success">
                                    <i class="fas fa-check "></i>&nbsp;&nbsp;&nbsp;Periode Aktif
                                </button>
                 <?php }else{ ?>
                      -
                <?php } ?>
                 ...
                 <a data-toggle="modal" data-target="#modal-edit<?php echo $periode->id_periode ?>" class="btn btn-outline btn-primary waves-effect waves-light"><span data-toggle="tooltip" data-original-title="Ubah"><font color="white"><i class="fas fa-pencil-alt"></i></font></span></a>
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <fieldset class="form-group floating-label-form-group">
                          ...
                          <input type="text" required name="nm_periode" class="form-control  round <?php echo form_error('nim') ? 'is-invalid':'' ?>" id="email" placeholder="Nama Periode" required>
                       <font color="red"><?php echo form_error('nm_periode') ?></font>
                        </fieldset>
                         <fieldset class="form-group floating-label-form-group">
                          <label for="email">Tahun Periode</label>
                          <input type="number" name="tahun" class="form-control round" id="email" placeholder="Tahun" required>
                        </fieldset>
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <fieldset class="form-group floating-label-form-group">
                          ...
                          <input type="text" value="<?php echo $periode->nm_periode ?>" required name="nm_periode" class="form-control  round <?php echo form_error('nim') ? 'is-invalid':'' ?>" id="email" placeholder="Email Address">
                       <font color="red"><?php echo form_error('nm_periode') ?></font>
                        </fieldset>
                         <fieldset class="form-group floating-label-form-group">
