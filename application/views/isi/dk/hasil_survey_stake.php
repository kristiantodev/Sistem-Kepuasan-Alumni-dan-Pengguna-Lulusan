...
<?php if ($myprodi->fakultas == "FTI") {?>
  ...
  <!-- selesai row -->
                                            ...
                                            <ul class="nav nav-tabs nav-tabs-custom" role="tablist">
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link active" data-toggle="tab" href="#profile1" role="tab"><b><font color=""><i class="fas fa-chart-bar"></i>&nbsp; Kinerja Alumni
                                                    <?php if ($myprodi->fakultas == "FTI") {?>
                 Fakultas Teknologi Informasi
                                        <?php }else{ ?>
                 ...
                 Fakultas Ekonomi & Bisnis
                                        <?php } ?></font></b></a>
                                            ...
                                            <div class="tab-content">
                                              ...
                                              <center><h4 class="mt-0 header-title"><b>Kinerja Alumni Berdasarkan Program Studi</b></h4></center>      
    <canvas id="terbaik" height="100"></canvas>
                                ...
                                <center><h4 class="mt-0 header-title"><b>Tingkat Kinerja dan Harapan Pengguna Lulusan (Indikator)</b></h4></center>                      
                                            <canvas id="alum" height="150"></canvas>
                                                 ...
                                                 <center><h6><b>Laporan Survei Kepuasan Pengguna Lulusan<br> 
                 ...
                 Fakultas Ekonomi & Bisnis
                                        <?php } ?>
                                                 ...
                                                 <br> Periode <?=$periodeku2->tahun;?></b></h6></center>
