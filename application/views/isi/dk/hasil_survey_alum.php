...
<?php if ($myprodi->fakultas == "FTI") {?>
  ...
  <!-- selesai row -->
                                            ...
                                            <ul class="nav nav-tabs nav-tabs-custom" role="tablist">
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link active" data-toggle="tab" href="#home1" role="tab"><b><font color=""><i class="fas fa-chart-pie"></i>&nbsp; Grafik Tingkat Kinerja dan Harapan Alumni</font></b></a>
                                                </li>
                                            ...
                                            <canvas id="alum" height="300"></canvas>
                                   ...
                                   <div id="box">
                                    ...
                                    <th width="99"><b>Kurang</b></th>
                                                ...
                                                <tr align="center">
                                                  ...
                                                  <td align="left"><?php echo $lap->nm_prodi ?></td>
...
$(function () {
 ...
 if( $('#alum').length > 0 ){
        ...
        var data2 = {
          ...
          "<?php echo $grafik2->nm_prodi ?> - <?php echo $grafik2->nm_indikator ?> (<?php echo $grafik2->tahun ?>)",
         <?php endforeach; ?>
            ],
            datasets: [
                {
