...
Program Studi : <?=$myprodi->nm_prodi;?></b></h6>
  ...
  <!-- selesai row -->
                                            ...
                                            <ul class="nav nav-tabs nav-tabs-custom" role="tablist">
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link active" data-toggle="tab" href="#home1" role="tab"><b><font color=""><i class="fas fa-th-large"></i>&nbsp; Hasil Survei Alumni</font></b></a>
                                                </li>

                                                <li class="nav-item">
                                                    <a class="nav-link" data-toggle="tab" href="#home3" role="tab"><b><font color=""><i class="fas fa-chart-bar"></i>&nbsp; Grafik Jumlah Responden</font></b></a>
                                                </li>

                                                <li class="nav-item">
                                                    <a class="nav-link" data-toggle="tab" href="#home2" role="tab"><b><font color=""><i class="fas fa-chart-pie"></i>&nbsp; Grafik Tingkat Kinerja dan Harapan</font></b></a>
                                                </li>
                                 ...
                                 <?php $no=1; foreach ($isiku as $isi): ?>
                                   ...
                                   <?php endforeach; ?>
                                                ...
                                                <div class="tab-pane p-3" id="home3" role="tabpanel">

                                            <canvas id="chart_jumlah" height="400" width='999'></canvas>
                                    ...
                                    <div id="box"> 
                                                 ...
                                                 <center><h6><b>Laporan Survei Kepuasan Alumni Universitas CIC<br> Program Studi <?=$myprodi->nm_prodi;?><br> Periode <?=$periodeku2->tahun;?></b></h6></center>
...
$(function () {
 ...
 if( $('#alum').length > 0 ){
    ...
    if( $('#chart_jumlah').length > 0 ){
        var ctx2 = document.getElementById("chart_jumlah").getContext("2d");
        var data2 = {
            labels: [
            <?php foreach ($grafiku as $grafik): ?>
