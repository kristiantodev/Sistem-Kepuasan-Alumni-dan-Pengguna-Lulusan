...
<html>
    ...
    <head>
        ...
        <title>Sistem Alumni - Halaman Alumni</title>
                            ...
                            <div class="dropdown notification-list nav-pro-img">
                              ...
                              <img src="<?php echo base_url('assets/images/users/'.$myuser->foto) ?>" alt="user" class="rounded-circle">
                                ...
                                <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                                    ...
                                    <a class="dropdown-item d-block" href="<?php echo site_url();?>halaman_alumni/ubahpassword"><i class="mdi mdi-settings m-r-5"></i> Ganti Password</a>
...
<div class="user-details">
                        ...
                        <div class="user-info">
                            <div class="dropdown">
                       <font color="#0285b4"><b><?php echo $myuser2->nama ?></b></font>
                                    
                               
                                
                            </div>
                            
                            <p class="text-white"><font color="#0285b4">Alumni</font></p>
                        </div>
                    </div>
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li>
                                <a href="<?php echo site_url();?>halaman_alumni/dashboard" class="waves-effect">
                                    <font color=""><i class="fa fa-home"></i></font><span> Dashboard </span>
                                </a>
                            </li>

                            <li>
                                <a href="<?php echo site_url();?>halaman_alumni/riwayat_pekerjaan" class="waves-effect">
                                    <font color=""><i class="fas fa-toolbox"></i></font><span> Riwayat Pekerjaan </span>
                                </a>
                            </li>

                            <li>
                                <a href="<?php echo site_url();?>halaman_alumni/survey" class="waves-effect">
                                    <font color=""><i class="fas fa-tasks"></i></font><span> Survei Kepuasan</span>
                                </a>
                            </li>

                            <li>
                                <a href="<?php echo site_url();?>halaman_alumni/ubahpassword" class="waves-effect">
