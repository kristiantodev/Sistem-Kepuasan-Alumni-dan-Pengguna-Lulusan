...
<div class="user-details">
                        ...
                        <div class="user-info">
                            <div class="dropdown">
                       <font color="#0285b4"><b>Amroni Duraji, M.M.</b></font>
                                    
                               
                                
                            </div>
                            
                            <p class="text-white"><font color="#0285b4">Bag. Kemahasiswaan</font></p>
                        </div>
                    </div>
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="submenu">
                                    <li><a href="<?php echo site_url();?>adm/periode"><i class="fas fa-clock "></i> &nbsp;Periode</a></li>
                                    <li><a href="<?php echo site_url();?>adm/instansi"><i class="fas fa-handshake"></i> &nbsp;Instansi</a></li>
                                    <li><a href="<?php echo site_url();?>adm/indikator"><i class="fas fa-tags "></i> &nbsp;Indikator</a></li>
                                    <li><a href="<?php echo site_url();?>adm/pertanyaan"><i class="fas fa-question-circle"></i> &nbsp;Pertanyaan</a></li>
                                </ul>
                            </li>
                            ...
                            <li>
                                ...
                                <ul class="submenu">
                                    <li><a href="<?php echo site_url();?>adm/alumni"><i class="fas fa-user-graduate"></i> &nbsp;Alumni</a></li>
                                    <li><a href="<?php echo site_url();?>adm/stakeholder"><i class="fa fa-user-tie"></i>&nbsp;Pengguna Lulusan</a></li>
                            ...
                            <li>
                                ...
                                <ul class="submenu">
                                    <li><a href="<?php echo site_url();?>adm/hasil_survey/alumni"><i class="fas fa-graduation-cap"></i> &nbsp;Kepuasan Alumni</a></li>
                                    <li><a href="<?php echo site_url();?>adm/hasil_survey/stakeholder">&nbsp;<i class="fab fa-black-tie"></i> &nbsp;Kepuasan P.Lulusan</a></li>
                                </ul>
                            </li>
