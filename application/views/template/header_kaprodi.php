                            ...
                            <div class="dropdown notification-list nav-pro-img">
                              ...
                              <img src="<?php echo base_url('assets/images/users/'.$myuser->foto) ?>" alt="user" class="rounded-circle">
                                ...
                                <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                                    ...
                                    <a class="dropdown-item d-block" href="<?php echo site_url();?>kaprodi/ubah_password"><i class="mdi mdi-settings m-r-5"></i> Ganti Password</a>
...
<div class="user-details">
                       ...
                       <font color="#0285b4"><b><?php echo $this->session->userdata('nm_user'); ?></b></font>
                            ...
                            <p class="text-white"><font color="#0285b4">Kaprodi</font></p>
                        </div>
                    </div>
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li>
                                <a href="<?php echo site_url();?>kaprodi/dashboard" class="waves-effect">
                            ...
                            <li>
                                ...
                                <ul class="submenu">
                                    <li><a href="<?php echo site_url();?>kaprodi/hasil_survey/alumni"><i class="fas fa-graduation-cap"></i> &nbsp;Kepuasan Alumni</a></li>
                                    <li><a href="<?php echo site_url();?>kaprodi/hasil_survey/stakeholder">&nbsp;<i class="fab fa-black-tie"></i> &nbsp;Kepuasan P.Lulusan</a></li>
                                </ul>
                            </li>
                            ...
                            <li>
                                ...
                                <ul class="submenu">
                                    <li><a href="<?php echo site_url();?>kaprodi/csi/alumni"><i class="far fa-meh"></i> &nbsp;CSI Alumni</a></li>
                                    <li><a href="<?php echo site_url();?>kaprodi/csi/stakeholder"><i class="far fa-meh"></i> &nbsp;CSI Stakeholder</a></li>
                                    <li><a href="<?php echo site_url();?>kaprodi/ipm/alumni"><i class="fas fa-chart-line"></i> &nbsp;IPA-Matrix Alumni</a></li>
                                    <li><a href="<?php echo site_url();?>kaprodi/ipm/stakeholder"><i class="fas fa-chart-line"></i> &nbsp;IPA-MatrixStakeholder</a></li>
                                </ul>
                            </li>
